...
var _Object$defineProperty = __webpack_require__(89);
...
var _Symbol$iterator = __webpack_require__(99);
...
var object_assign = __webpack_require__(18);
...
function fetch_Headers(headers) {
  ...
  if (headers instanceof fetch_Headers) {
...
if (support.iterable) {
  fetch_Headers.prototype[Symbol.iterator] = fetch_Headers.prototype.entries
}
...
// CONCATENATED MODULE: ./lib/method.js
/**
 * @file request support methods
 * Created by Xinyi on 2019/2/12.
 */
/* harmony default export */ var method = ({
  GET: 'GET',
  POST: 'POST',
  PUT: 'PUT',
  DELETE: 'DELETE',
...
var get_iterator = __webpack_require__(60);
...
function paramsToString(params) {
  if (typeof_default()(params) === 'object') {
    ...
    for (var paramKey in params) {
      ...
      if (typeof_default()(paramValue) === 'object') {
        paramArr.push("".concat(paramKey, "=").concat(encodeURIComponent(stringify_default()(paramValue))));
      } else if (paramValue) {
        paramArr.push("".concat(paramKey, "=").concat(encodeURIComponent(paramValue)));
      }
    }

    return paramArr.join('&');
  } else if (typeof params === 'string') return params;else return '';
}
/**
 * koa-compose code
...
function compose(middlewares) {
  if (!is_array_default()(middlewares)) {
  ...
  try {
    for (var _iterator = get_iterator_default()(middlewares), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var fn = _step.value;
  ...
  return function (context, next) {
    ...
    function dispatch(i) {
      if (i <= index) {
        return promise_default.a.reject(new Error('next() called multiple times'));
      }
      ...
      try {
        return promise_default.a.resolve(fn(context, dispatch.bind(null, i + 1)));
      } catch (err) {
...
function Context(_ref) {
  ...
  options.headers = headers = new Headers(assign_default()({
    'Content-Type': 'application/json',
    'Accept': 'application/json'
  }, opts.headers)); // Options

  var keyString = ['method', 'mode', 'cache', 'credentials', 'redirect', 'referrer', 'body'];
  keyString.every(function (item) {
    if (opts[item]) {
  ...
  url = "".concat(opts.prefix || '').concat(url);

  if (params && options.method === method.GET && keys_default()(params).length) {
    url = "".concat(url, "?").concat(paramsToString(params));
  } // Body
  ...
  if (params && !options.body && options.method !== method.GET) {
    ...
    } else options.body = stringify_default()(params);
  } // Request
...
// CONCATENATED MODULE: ./lib/fetch2.js
...
/*#__PURE__*/
function () {
  createClass_default()(fetch2, null, [{
    key: "getInstance",
  ...
  function fetch2(opts) {
    classCallCheck_default()(this, fetch2);
    ...
    var defaultOptions = {
      ...
      cache: 'no-cache',
      timeout: 3000 // total options

    };
    this.options = assign_default()({}, defaultOptions, opts); // middlewares
  ...
  createClass_default()(fetch2, [{
    key: "request",
    value: function request(url) {
      var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var opts = arguments.length > 2 ? arguments[2] : undefined;
      var fn = compose(this.middlewares.concat(this.fetch()));
      var ctx = new context_Context({
        url: url,
        params: params,
        opts: assign_default()({}, this.options, opts)
      });
    ...
    value: function handleRequest(ctx, fn) {
      ...
      return fn(ctx).then(function (response) {
        if (!ctx) throw response;
        return _this.handleResponse(ctx.response);
      ...
      return function (ctx) {
        var f = fetch(ctx._request).then(function (response) {
          ...
          if (response.ok) {
            ...
            throw new Error(stringify_default()(response));
          }
...
/**
 * @file fetch2 module index
 * Created by Xinyi on 2019/2/26.
 */

/* harmony default export */ var lib = __webpack_exports__["default"] = (fetch2_fetch2);
